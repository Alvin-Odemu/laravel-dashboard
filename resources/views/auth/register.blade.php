                ...
                <div class="col-lg-5 col-md-5 ml-auto">
                    <div class="info-area info-horizontal mt-5">
                        ...
                        <div class="description">
                            <h5 class="info-title">{{ __('Crossfit') }}</h5>
                            <p class="description">
                                {{ __('This core value highlights the importance of building a supportive and inclusive community where participants encourage and motivate each other.') }}
                            </p>
                        </div>
                    </div>
                    <div class="info-area info-horizontal">
                        ...
                        <div class="description">
                            <h5 class="info-title">{{ __('Weight Lifting') }}</h5>
                            <p class="description">
                                {{ __('Weightlifting places a strong emphasis on technical precision. This core value underscores the importance of mastering lifting techniques to optimize performance and reduce the risk of injury.') }}
                            </p>
                        </div>
                    </div>
                    <div class="info-area info-horizontal">
                        ...
                        <div class="description">
                            <h5 class="info-title">{{ __('Calesthetis') }}</h5>
                            <p class="description">
                                {{ __('Calisthenics is a fitness discipline that emphasizes bodyweight exercises and functional movements.') }}
                            </p>
                        </div>
                    </div>
                </div>
