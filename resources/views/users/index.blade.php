                ...
                <div class="sidebar" data-color="white" data-active-color="danger">
                    ...
                    <div class="sidebar-wrapper">
                        <ul class="nav">
                            ...
                            <li >
                                <a data-toggle="collapse" aria-expanded="true" href="#myprofile">
                                    ...
                                    <ul class="nav">
                                        <li >
                                            <a href="{{ route('profile.edit') }}">
                                                ...
                                                <span class="sidebar-normal">{{ __(' View Profile ') }}</span>
                                            </a>
                                        </li>
                                        <li class="active">
                                            <a href="{{ route('page.index', 'user') }}">
                                                <span class="sidebar-mini-icon">{{ __('U') }}</span>
                                                <span class="sidebar-normal">{{ __(' Manage Profile') }}</span>
                                            </a>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <li >
                                <a href="{{ route('page.index', 'trainers') }}">
